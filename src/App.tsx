...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20">
      {/* Stats bar */}
      <StatsBar stats={stats} isOnline={isOnline} />
      ...
      {/* Report download + Manage Guests */}
      {!query && (
        <div className="mx-4 mt-4 mb-24 space-y-3">
          <button
            onClick={() => setShowManage(true)}
            className="w-full py-3 rounded-xl border-2 border-sunflower-300 bg-sunflower-50
                       text-sunflower-700 font-semibold text-sm
                       hover:bg-sunflower-100 active:bg-sunflower-200 transition-colors
